# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-08-18 03:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('email', 'Email'), ('webhook', 'Webhook'), ('hipchat', 'HipChat'), ('slack', 'Slack'), ('pd', 'PagerDuty'), ('po', 'Pushover'), ('pushbullet', 'Pushbullet'), ('opsgenie', 'OpsGenie'), ('victorops', 'VictorOps'), ('sms', 'Sms'), ('discord', 'Discord')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('kind', models.CharField(choices=[('simple', 'Simple'), ('cron', 'Cron')], default='simple', max_length=10)),
                ...
                ('tz', models.CharField(default='UTC', max_length=36)),
